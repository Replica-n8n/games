...
var Sons = (function(){
  ...
  var VOIX = {
    ...
    /* les cinq fruits reunis : la plus grosse fanfare du jeu */
    etoile:   { repos: 0.5, jouer: function(){
      [523, 659, 784, 1047, 1319, 1568].forEach(function(h, i){
        note({ forme: "triangle", de: h, duree: 0.2, force: 0.17, retard: i * 0.06 });
      });
    }},
    ...
    malus:    { repos: 0.4, jouer: function(){
